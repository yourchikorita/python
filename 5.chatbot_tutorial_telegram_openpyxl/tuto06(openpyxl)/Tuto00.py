...
def write_with_cell():
    ...
    """
    tuto_db.cell(row=1, column=1, value='SBA 점ssssssss심타임')
    print(tuto_db.cell(row=2, column=1))
    tuto_db.cell(row=2, column=1).value = 0
    tuto_db.cell(row=2, column=1).value += 1
    print(tuto_db.cell(row=2, column=1).value)
